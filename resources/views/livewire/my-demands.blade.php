...
<div class="card overflow-auto  col-3 bg-light ticket-container">
    ...
    <div class="card-body p-0">
        ...
        <div class="card   list-group-item-action  border-0 mb-2  shadow" data-toggle="modal"
            data-target="#my-demand{{$myDemand->id}}">
            <div class="card-body px-2 py-2">
                ...
                <div class="d-flex justify-content-between mt-2">
                    <div class="p-0 btn" data-toggle="modal">
                        <span class="badge badge-pill badge-dark">{{$myDemand->user->name}}</span>
        ...
        <!-- My Demand Modal -->
        @if ($myDemands->isNotEmpty())
        <div wire:ignore.self class="modal fade" id="my-demand{{$myDemand->id}}" tabindex="-1"
                    ...
                    <div class="modal-body text-right">
                        <form class="m-4">
                            ...
                            <div class="form-group">
                                ...
                                <div>
                                    <label class="text-bold">درخواست کننده :</label>
                                    <label>{{$myDemand->user->name}}</label>
                                </div>
                                <div>
