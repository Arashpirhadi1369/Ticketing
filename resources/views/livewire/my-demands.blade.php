    ...
    <div class="card-body p-0">
        <div class="card   list-group-item-action  border-0 mb-2  shadow">
            <div class="card-body px-2 py-2">
                <div class="mt-1 p-0 btn"  data-toggle="modal" data-target="#MyDemand-demand">
                    <p class="text-small text-bold mb-0 text-right">150 -   ویندوز من خراب شده ، مرتیکه بیا درستش کن</p>
                </div>
                <div class="d-flex justify-content-between mt-2">
                    <div class="p-0 btn" data-toggle="modal" data-target="#MyDemand-demand">
                        <span class="badge badge-pill badge-dark">مسعود قاسمی تاج</span>
                        <span class="badge badge-pill badge-info">در حال بررسی</span>
                    </div>
                    <div>
