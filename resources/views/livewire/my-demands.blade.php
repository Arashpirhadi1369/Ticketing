<!-- My Demand  -->
<div class="card overflow-auto  col-3 bg-light ticket-container">
    ...
    <div class="card-body p-0">
        @foreach($myDemands as $myDemand)
            <div class="card   list-group-item-action  border-0 mb-2  shadow"
                 data-toggle="modal" data-target="#MyDemand-demand{{$myDemand->id}}">
                <div class="card-body px-2 py-2">
                    <div class="mt-1 p-0 btn">
                        <p class="text-small text-bold mb-0 text-right">{{$myDemand->id}} - {{$myDemand->subject}}</p>
                    </div>
                    <div class="d-flex justify-content-between mt-2">
                        <div class="p-0 btn" data-toggle="modal">
                            <span class="badge badge-pill badge-dark">{{$myDemand->referred->name}}</span>
                            <span class="badge badge-pill badge-info">{{$myDemand->status->status}}</span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div wire:ignore.self class="modal fade" id="all-demand{{$myDemand->id}}" tabindex="-1"
                    ...
                    <div class="modal-content"  style="background-color: #f4f5f7">
                        <div class="modal-header mx-4 mt-3">
                            <div class="d-flex align-items-center">
                                ...
                                <span class="badge badge-pill badge-primary">{{$myDemand->status->status}}</span>
                            </div>
                                    ...
                                    <div class="d-flex justify-content-between">
                                        ...
                                        <div class="d-flex">
                                            <div>
                                                ...
                                                <label>{!! jdate($myDemand->created_at)->format('Y-m-d')!!}</label>
                                            </div>
                                            <div class="mr-3">
                                                <label class="text-bold">تاریخ ارجاع :</label>
                                                <label>{!! jdate($myDemand->updated_at)->format('Y-m-d')!!}</label>
                                            </div>
                                        </div>
                                    </div>
                                    <div>
                                        <label class="text-bold">انجام دهنده :</label>
                                        <label>{{$myDemand->referred->name}}</label>
                                    </div>
                                    <div>
