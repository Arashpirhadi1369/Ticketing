<div xmlns:livewire="">
    <div class="d-flex " >
        ...
        <div class="col-9  mt-4 pr-0">
            <div class="card border-0 bg-light  shadow  d-flex align-content-center" style="height: 70px;border-radius: 10px">
                <div class="card-body row mt-1">
                    <div class="mr-3 row">
                        <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" class=" ml-2 bi bi-person-circle" viewBox="0 0 16 16">
                    ...
                    <div class="mr-4 row" >
                        <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" class="ml-2 mr-4 bi bi-diagram-3-fill" viewBox="0 0 16 16">
