<div>
    <div class="d-flex ">
        ...
        <div class="col-3 my-4" id="navbar-dashboard">
            <div class=" bg-light shadow  mr-2 " id="navbar-dashboard">
                        ...
                        <ul class="navbar-nav d-flex flex-column">
                            ...
                            <li class="nav-item my-3">
                                <form method="POST" action="{{ route('logout') }}">
                                    @csrf
                                    <a class="nav-link d-flex text-danger align-items-center text-bold"
                                        href="{{ route('logout') }}" onclick="event.preventDefault();
                                this.closest('form').submit();">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="red"
                                            class="ml-2 bi bi-power" viewBox="0 0 16 16">
                ...
                <div class="d-flex justify-content-center align-content-around">
                    <button class="btn d-flex flex-row justify-content-center  align-items-center" style="color: green"
                        data-toggle="modal" data-target="#insert-demand">
        ...
        {{--Create Ticket Modal--}}
        <div wire:ignore.self class="modal fade" id="insert-demand" tabindex="-1" aria-labelledby="exampleModalLabel"
            aria-hidden="true">
        ...
        <div class="col-9  mt-4 pr-0">
            <div class="card border-0 bg-light  shadow  d-flex align-content-center"
