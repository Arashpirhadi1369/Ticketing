<div>
    ...
    @include('layouts.modals.info-survey-modal')
            ...
            <div class="card mt-4 shadow" style="border-radius: 10px">
                <div class="card-body">
                    <div class="d-flex mb-3 justify-content-between align-items-center">
                        <div class="d-flex align-items-center">
                            <p class="h5 text-bold mb-0 ml-3">تکمیل فرم نظرسنجی</p>
                    ...
                    <table id="table" class="table table-striped table-bordered" style="width:100%">
                        ...
                        <tbody>
                            ...
                            <tr class="text-center">
                                ...
                                @elseif($header == 'survey_finished_date')
                                <td wire:click="edit({{ $entity->id }})" class="" data-toggle="modal"
                                    data-target="#infoModal">
                                    {{$entity->survey_finished_date}}
                                </td>
                ...
                <div
                    ...
                    <div class="d-flex flex-row">
                        ...
                        @endif
                        @if ($loop->iteration == count($filters))
                        <small>نمایش اطلاعات دوره های آموزشی</small>
                        @endif
                        @endforeach
