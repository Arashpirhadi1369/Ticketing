                        ...
                        <div class="card shadow col-md-6 col-lg-7 col-xl-8 ml-1" style="border-radius: 10px">
                            <div class="mt-4">
                                <div class="d-flex justify-content-around">
                                    <div class="">
                                        <input wire:model.debounce.500ms='ticket.subject' placeholder="نام مخاطب" class="form-control">
                                    </div>
                                    <div class=" ">
                                        <input wire:model.debounce.500ms='ticket.subject' placeholder="شماره همراه" class="form-control">
                                    </div>
                                    <div class="">
                                        <input wire:model.debounce.500ms='ticket.subject' placeholder="تاریخ ارسال" class="form-control">
                                    </div>
                                    <div class="">
                            ...
                            <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content" style="background-color: #f4f5f7">
                                        ...
                                        <div class="modal-body text-right">
                                            <form  class="m-4">
                                                <div class="form-group d-flex justify-content-between col-md-8 p-0">
                                                    <div class="">
                                                        <label class="text-bold"> نام مخاطب :</label>
                                                        <lable></lable>
                                                    </div>
                                                    <div class="">
                                                        <label class="text-bold"> شماره همراه :</label>
                                                ...
                                                <div class="form-group ">
                                                    <div>
                                                        ...
                                                        <label class="text-bold">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Natus reiciendis a pariatur amet, dolorem quos sed quisquam expedita dolorum maiores non optio est dolor ea debitis provident, iusto saepe labore.</label>
                                                    </div>
                                                </div>
                                            </form>
                                        </div>
                        ...
                        <div class="card shadow col-md-6 col-lg-5 col-xl-4 " style="border-radius: 10px">
                            <div class="card-body">
                                <div class="d-flex align-items-center my-3">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="green" class="bi bi-send-plus" viewBox="0 0 16 16">
                                ...
                                <div class="mr-4">
                                    <button wire:click='store'
                                    type="button" class="btn btn-success">ارسال پیام</button>
                                    <button wire:click='resetInput' type="button" data-dismiss="modal"
                                            class="btn btn-outline-danger">حذف پیام</button>
                                </div>
                            </div>
                        </div>
                    </div>
