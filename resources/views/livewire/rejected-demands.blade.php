<div class="col-3  px-0">
    ...
    <div class="card  overflow-auto px-2  bg-light ticket-container">
        <div class="d-flex justify-content-between align-items-center">
            <div class="card-header bg-light text-danger border-0">
                رد شده
                <span class="badge badge-pill badge-danger">{{$rejectedDemands->count()}}</span>
            </div>
            <div class="">
        ...
        <div class="card-body p-0">
            ...
            <div class="card   list-group-item-action  border-0 mb-2  shadow">
                <div class="card-body px-2 py-2" data-toggle="modal"
                    data-target="#rejected-demand{{$rejectedDemand->id}}">
                    ...
                    <div class="d-flex justify-content-between mt-2">
                        <div class="p-0 btn" data-toggle="modal" data-target="#rejected-demand">
                            <span class="badge badge-pill badge-dark">{{__($rejectedDemand->user->name)}}</span>
                            <span class="badge badge-pill badge-danger">{{__($rejectedDemand->status->status)}}</span>
                            <span class="badge badge-pill badge-danger">{{__($rejectedDemand->referred->name)}}</span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="modal fade" id="rejected-demand{{$rejectedDemand->id}}" tabindex="-1"
                            ...
                            <form class="m-4">
                                    ...
                                    <div class="d-flex justify-content-between">
                                        ...
                                        <div class="d-flex">
                                            <div>
                                                ...
                                                <label>{!!
                                                    jdate($rejectedDemand->created_at)->format('Y-m-d')!!}</label>
                                            </div>
                                            <div class="mr-3">
                                                <label class="text-bold">تاریخ ارجاع :</label>
                                                <label>{!!
                                                    jdate($rejectedDemand->updated_at)->format('Y-m-d')!!}</label>
                                            </div>
                                        </div>
                                    </div>
                                    <div>
                                        <label class="text-bold">درخواست دهنده :</label>
                                        <label>{{__($rejectedDemand->user->name)}}</label>
                                    </div>
                                    <div>
                                ...
                                <div class="form-group">
                                    <div>
                                        ...
                                        <label>{{$rejectedDemand->reply}}</label>
                                    </div>
                                </div>
                            </form>
                        </div>
        ...
        {{-- <table class="table table-bordered  mt-2" id="myTable">--}}
            ...
            {{-- <tbody>--}}
                ...
                {{-- <tr class="text-sm  text-bold ">--}}
                    ...
                    {{-- <td>{!! jdate($rejectedDemand->created_at)->format('Y-m-d')!!}</td>--}}
                    {{-- <td>{{$rejectedDemand->subject}}</td>--}}
                    {{-- <td>{{$rejectedDemand->status->status}}</td>--}}
                    {{-- <td>{{$rejectedDemand->user->name}}</td>--}}
                    {{-- </tr>--}}
                {{-- @endforeach--}}
                {{-- </tbody>--}}
            {{-- </table>--}}
        {{-- <div class="mr-4 ">--}}
            {{-- {{ $rejectedDemands->links('vendor.livewire.bootstrap') }}--}}
            {{-- </div>--}}
        {{--
        <!-- Modal -->--}}
        {{-- <div class="modal fade" id="rejected-demand" tabindex="-1" aria-labelledby="exampleModalLabel" --}} {{--
            aria-hidden="true">--}}
            {{-- <div class="modal-dialog modal-lg modal-dialog-scrollable">--}}
