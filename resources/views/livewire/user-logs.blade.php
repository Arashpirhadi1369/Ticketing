            ...
            <div class="card mt-4 shadow" style="border-radius: 10px">
                <div class="card-body">
                    <div class="d-flex mb-3 justify-content-between align-items-center">
                        <div class="d-flex align-items-center">
                            <p class="h5 text-bold mb-0 ml-3">لاگ کاربران</p>
                    ...
                    <table id="table" class="table table-striped table-bordered" style="width:100%">
                        ...
                        <tbody>
                            ...
                            <tr class="text-center">
                                ...
                                <td>
                                    @if ($entity['action_id'] == 1)
                                    ایجاد
                                    @elseif($entity['action_id'] == 2)
                                    ویرایش
                                    @elseif($entity['action_id'] == 3)
                                    حذف
                                    @endif
                                </td>
                                <td>
                ...
                <div
                    ...
                    <div class="d-flex flex-row">
                        ...
                        @endif
                        @if ($loop->iteration == count($filters))
                        <small>نمایش اطلاعات لاگ کاربران</small>
                        @endif
                        @endforeach
