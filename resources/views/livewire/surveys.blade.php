<div>
    ...
    @include('layouts.modals.create-question-modal')
    @include('layouts.modals.create-answer-modal')
            ...
            <div class="card mt-4 shadow" style="border-radius: 10px">
                <div class="card-body">
                    <div class="d-flex mb-3 justify-content-between align-items-center">
                        <div class="d-flex align-items-center">
                            <p class="h5 text-bold mb-0 ml-3">مدیریت نظرسنجی ها</p>
                            ...
                            <tr class="text-center">
                                ...
                                <td>
                                    <div>
                                        ...
                                        @permission("effectivenesses-update")
                                        ...
                                        <button wire:click="edit({{ $entity->id }})"
                                            class="btn text-info bg-transparent border-0" type="button"
                                            data-toggle="modal" data-target="#createQuestionModal">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"
                                                fill="currentColor" class="bi bi-pencil-square" viewBox="0 0 16 16">
                                                <path
                                                    d="M15.502 1.94a.5.5 0 0 1 0 .706L14.459 3.69l-2-2L13.502.646a.5.5 0 0 1 .707 0l1.293 1.293zm-1.75 2.456l-2-2L4.939 9.21a.5.5 0 0 0-.121.196l-.805 2.414a.25.25 0 0 0 .316.316l2.414-.805a.5.5 0 0 0 .196-.12l6.813-6.814z" />
                                        ...
                                        <button wire:click="edit({{ $entity->id }})"
                                            class="btn text-info bg-transparent border-0" type="button"
                                            data-toggle="modal" data-target="#createAnswerModal">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"
                                                fill="currentColor" class="bi bi-pencil-square" viewBox="0 0 16 16">
                                                <path
                                                    d="M15.502 1.94a.5.5 0 0 1 0 .706L14.459 3.69l-2-2L13.502.646a.5.5 0 0 1 .707 0l1.293 1.293zm-1.75 2.456l-2-2L4.939 9.21a.5.5 0 0 0-.121.196l-.805 2.414a.25.25 0 0 0 .316.316l2.414-.805a.5.5 0 0 0 .196-.12l6.813-6.814z" />
                                        ...
                                        @permission("effectivenesses-delete")
                                        <button wire:click="edit({{ $entity->id }})"
                ...
                <div
                    ...
                    <div class="d-flex flex-row">
                        ...
                        @endif
                        @if ($loop->iteration == count($filters))
                        <small>نمایش اطلاعات نظرسنجی ها</small>
                        @endif
                        @endforeach
