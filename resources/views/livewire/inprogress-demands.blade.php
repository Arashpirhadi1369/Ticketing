<div>
    ...
    <div class="table-responsive">
                ...
                <tr class="text-sm  text-bold ">
                    <td class="p-0 ">
                        ...
                        <button class="btn btn-sm mt-2" data-placement="bottom" title="مشاهده جزئیات تیکت"
                            data-toggle="modal" data-target="#inprogress-demand">
                    ...
                    <td>{!! jdate($inprogressDemand->created_at)->format('Y-m-d')!!}</td>
        ...
        <!-- Modal -->
        <div class="modal fade" id="inprogress-demand" tabindex="-1" aria-labelledby="exampleModalLabel"
            aria-hidden="true">
