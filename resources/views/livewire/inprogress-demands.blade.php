<div class="col-3  px-0">
    ...
    <div class="card overflow-auto px-2  bg-light ticket-container">
        ...
        <div class="card-body p-0">
            ...
            <div wire:ignore.self class="modal fade" id="inprogress-demand{{$inprogressDemand->id}}" tabindex="-1"
                                    ...
                                    <div class="d-flex justify-content-between">
                                        ...
                                        <div class="d-flex">
                                            <div>
                                                ...
                                                <label>{!!
                                                    jdate($inprogressDemand->created_at)->format('Y-m-d')!!}</label>
                                            </div>
                                            <div class="mr-3">
                                                <label class="text-bold">تاریخ ارجاع :</label>
                                                <label>{!!
                                                    jdate($inprogressDemand->updated_at)->format('Y-m-d')!!}</label>
                                            </div>
                                        </div>
                                    </div>
                                    <div>
