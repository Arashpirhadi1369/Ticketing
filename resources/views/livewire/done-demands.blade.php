<div class="col-3  px-0">
    ...
    <div class="card mb-1 overflow-auto px-2  bg-light ticket-container">
        ...
        <div class="card-body p-0">
                ...
                <div class="card-body px-2 py-2" data-toggle="modal" data-target="#done-demand{{$doneDemand->id}}">
                    ...
                    <div class="d-flex justify-content-between mt-2">
                        <div class="p-0 btn" data-toggle="modal" data-target="#done-demand">
                            <span class="badge badge-pill badge-dark">{{__($doneDemand->user->name)}}</span>
                            <span class="badge badge-pill badge-success">{{__($doneDemand->status->status)}}</span>
                            <span class="badge badge-pill badge-success">{{__($doneDemand->referred->name)}}</span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="modal fade" id="done-demand{{$doneDemand->id}}" tabindex="-1"
                            ...
                            <form class="m-4">
                                ...
                                <div class="form-group">
                                    ...
                                    <div>
                                        ...
                                        <label>{{__($doneDemand->user->name)}}</label>
                                    </div>
                                    <div>
                                        <label class="text-bold">انجام دهنده :</label>
                                        <label>{{__($doneDemand->referred->name)}}</label>
                                    </div>
                                    <div>
