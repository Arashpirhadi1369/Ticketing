                    ...
                    <form method="post" action="{{route('login')}}">
                        ...
                        <div class="form-group d-flex flex-column ">
                            ...
                            <div class="form-control bg-light input-group x-input">
                                ...
                                <input type="password"
                                    class="form-control text-bold x-input border border-right-0 text-right "
                                    name="password" id="password" placeholder="کلمه عبور">
                            </div>
                        </div>
                        ...
                        {{-- <div class="form-group mr-3">
                            <a href="{{route('password.request')}}" class="text-bold mt-4 text-small text-primary">کلمه
                                عبور خود را فراموش کرده ام ؟</a>
                        </div> --}}
                        <div class="form-group mx-3 ">
                            <button type="submit" class="btn mt-5 btn-lg my-3 btn-block btn-primary">ورود به
                                سامانه</button>
                        </div>
                    </form>
                </div>
