...
class AllDemandsExport implements FromCollection, WithHeadings, ShouldAutoSize, WithMapping, WithEvents, WithStyles
{
    private $row;
    ...
    public function map($allDemands): array
    {
        return [
            $allDemands->user->name,
            $allDemands->subject,
            $allDemands->content,
